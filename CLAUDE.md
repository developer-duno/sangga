...
```bash
python -m pytest tests/ -q                      # 파이썬 테스트 (1,778개)
...
python scripts/check_watch_heartbeat.py         # 감시 3종이 아직 돌고 있나 (읽기만, 키 불필요 — 기준 초과면 exit 1)
